...
if( !$_SESSION['logged'] && $_SESSION['logged_user'] < 1 ) exit();
$folderName = md5($_SESSION['logged_user']);
if (!file_exists('../../../images/files/'.$folderName)) {
    mkdir('../../../images/files/'.$folderName);
}
...
$opts = array(
	'root'            => '../../../images/files/'.$folderName.'/',                       // path to root directory
	'URL'             => $global->baseurl.'images/files/'.$folderName.'/', // root directory URL
	...
	// 		)
	// 	)
	'uploadAllow'  => array('image', 'application', 'text/plain', 'audio', 'video'),
	'uploadDeny'   => array('all'),
	'uploadOrder'  => 'deny,allow',
	'mimeDetect'   => 'internal'
);
