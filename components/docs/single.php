            ...
            $single = $singleArray[0];
                ...
                echo '<div class="article_body">';
                    ...
                    $db->query("SELECT a.*, b.email as voter_email, b.name as voter_name
                                ...
                                WHERE a.for_kn_id = '$single->id' AND a.from_user_id > 0 
                                GROUP BY a.id");
...
<div class="row">
    ...
    <div class="span4">
    	<h3 class="muted">Looking for something else?</h3>
        <form>
            <div class="input-append">
                <input id="keyword" type="text" value="<?php if(isset($keyword)) echo $keyword; ?>" placeholder="Search for a topic here">
                <div class="btn-group">
	...
	<div class="span5">
        ...
        <h3 class="muted">Original author of this wiki</h3>
        
        <div class="search-block well clearfix" style="background:url(<?php echo $global->baseurl.'images/users/r_'.$single->avatar; ?>) no-repeat">
            <?php
                echo '<div class="pull-right text-right art-info">';
